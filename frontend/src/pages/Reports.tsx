...
import { BarChart3, FileSpreadsheet, FileText, Download, TrendingUp, Users, Receipt, Clock } from "lucide-react";
...
import {
  getFinancialReport, getPaymentsReport, getPatientPaymentsReport, getPatientHistoryReport,
  type FinancialReportData, type PaymentRow, type PatientPaymentsReportData, type PatientHistoryReportData,
} from "../api/reports";
import { exportToCSV, exportToExcel, exportToPDF } from "../lib/export";
import { formatCurrency } from "../lib/format";
import type { Patient } from "../types";

type ReportType = "financial" | "payments" | "patientPayments" | "patientHistory";
...
export default function Reports() {
  ...
  const needsPatient = selected === "patientPayments" || selected === "patientHistory";
